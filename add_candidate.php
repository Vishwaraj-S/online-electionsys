...
<body>
	<h1 class="header">Admin Panel</h1><div class="pic">
	<br><br><br>
	<div class="link">
		<a href="add_anouncement.php" class="tab" >Add Anouncement</a>
		<a href="new_election.php" class="tab">New Election</a>
		<a href="add_candidate.php" class="tab" style="margin-left: 0px; margin-right: 0px; background-color: rgb(244,66,83); color:white;">&#9654;Add Candidate</a>
	...
	<p>Fill Candidate info</p>
		<form action="add_candidate.php" method="POST" enctype="multipart/form-data">
			<input type="text" class="rfield" name="fname" maxlength="20" pattern="[A-Za-z].{3,}"  placeholder="First Name" required autofocus>
			<input type="text" class="rfield" name="lname" maxlength="20" pattern="[A-Za-z].{3,}" placeholder="Last Name" required>
			...
			<br>
			<p style="text-align:left; font-size:17px; display:inline-block; margin-top:50px; margin-left:250px;">Select your image:</p><input type="file" name="image" required>
