...
<body>
	...
	<div class="link">
		...
		<a href="new_election.php" class="tab" style="margin-left: 0px; margin-right: 0px; background-color: rgb(244,66,83); color:white;">&#9654;New Election</a>
	...
	<p> Add New Election </p>
		<form action="new_election.php" method="POST">
			<input type='text' maxlength='30' placeholder='Election Name' pattern="[A-Za-z].{2,}" title="Only alphabetical characters allowed." style="margin-left:375px; margin-top: 100px;" name="name" class="field" autofocus required>
