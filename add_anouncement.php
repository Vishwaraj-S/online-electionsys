...
<body>
	...
	<br><br><br>
	<div class="link">
		<a href="add_anouncement.php" class="tab" style="margin-left: 0px; margin-right: 0px; background-color: rgb(244,66,83); color:white;">&#9654;Add Anouncement</a>
	...
	<p>Add An Anouncement below:</p>
		<form action="add_anouncement.php" method="POST" style="text-align: center;">
			<textarea name="anounce" style="background-color:rgba(244,66,83,0.7);color: white;outline:none; border:1px solid black;font-size: 20px;" class="textarea" maxlength="200" autofocus>
			</textarea>
